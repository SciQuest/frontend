      ...
      <div className="flex h-screen">
        ...
        <div className="relative overflow-x-auto w-4/5 px-2 bg-gray-100  shadow-md sm:rounded-lg">
          ...
          <div className=" flex mx-auto my-2 items-center justify-center">
            <label
              class=" mb-2 text-sm font-bold mx-2 text-blue-500 "
              for="file_input"
            >
              Upload PDF
            </label>
            <input
              class=" text-blue-500 px-2 py-4 border border-gray-300 rounded-lg cursor-pointer bg-blue-100  focus:outline-none  "
              id="file_input"
              type="file"
            />
          </div>
